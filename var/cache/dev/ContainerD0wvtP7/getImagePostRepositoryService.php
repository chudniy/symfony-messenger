...
// Returns the private 'App\Repository\ImagePostRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImagePostRepository.php';

return $this->privates['App\\Repository\\ImagePostRepository'] = new \App\Repository\ImagePostRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
