...
include_once $this->targetDirs[3].'/src/Serializer/Normalizer/ImagePostNormalizer.php';
...
$c = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($a, $b, new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, new \Symfony\Component\Cache\Adapter\ArrayAdapter(0, false), true), new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () {
...
}, 1)), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($a), NULL, []);

return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \App\Serializer\Normalizer\ImagePostNormalizer($c, ($this->privates['App\\Photo\\PhotoFileManager'] ?? $this->load('getPhotoFileManagerService.php')), ($this->services['router'] ?? $this->getRouterService())), 1 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 2 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 3 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $b), 4 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 5 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->load('getMimeTypesService.php'))), 6 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 7 => $c], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder()]);
